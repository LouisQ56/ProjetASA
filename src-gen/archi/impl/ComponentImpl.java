 ...
 * </p>
 * <ul>
 *   <li>{@link archi.impl.ComponentImpl#getInterface <em>Interface</em>}</li>
 *   <li>{@link archi.impl.ComponentImpl#getComponent <em>Component</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ComponentImpl extends MinimalEObjectImpl.Container implements Component {
	...
	protected EClass eStaticClass() {
		return ArchiPackage.Literals.COMPONENT;
	}
	...
	public EList<Interface> getInterface() {
		if (interface_ == null) {
			interface_ = new EObjectContainmentEList<Interface>(Interface.class, this,
					ArchiPackage.COMPONENT__INTERFACE);
		}
		return interface_;
	}
	...
	public EList<Component> getComponent() {
		if (component == null) {
			component = new EObjectContainmentEList<Component>(Component.class, this,
					ArchiPackage.COMPONENT__COMPONENT);
		}
		return component;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case ArchiPackage.COMPONENT__INTERFACE:
			return ((InternalEList<?>) getInterface()).basicRemove(otherEnd, msgs);
		case ArchiPackage.COMPONENT__COMPONENT:
